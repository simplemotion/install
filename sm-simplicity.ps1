...
# Thin wrapper around install.ps1 — installs sm-simplicity to PATH.
#
# Usage:
#   irm https://get.simplemotion.com/sm-simplicity.ps1 | iex
#   $env:SM_CHANNEL='preview'; irm https://get.simplemotion.com/sm-simplicity.ps1 | iex
